...
const CatalogItem = ({ classes, game }) => (
  <div className={classes.catalogListItem}>
    ...
    <a href="#" className={classes.catalogItemImg}>
    ...
    <div className={classes.catalogItemCounter}>
      <div className={classes.catalogCounterWins}>
        <p className={classes.catalogCounterBigstWin}>
          <span className={classes.catalogCounterValue}>{game.bigWin} dcb</span> <br /> BIGGEST WIN <br /> FOR ALL TIME
        </p>
      </div>
      <div className={classes.catalogCounterHours}>
        <p className={classes.catalogCounterHoursVolume}>
          <span className={classes.catalogCounterValue}>{game.volume} dcb</span> <br /> VOLUME OF <br />24 HOURS
        </p>
      </div>
      <div className={classes.catalogCounterContracts}>
        <p className={classes.catalogCounterContractsVolume}>
          <span className={classes.catalogCounterValue}>{game.volumeAll} dcb</span> <br /> ALL VOLUME OF <br /> SMART CONTRACT
        </p>
      </div>
    </div>
    <a href="#" className={cn(classes.catalogItem, classes.catalogItemBtn)}>
      Play Now</a>
    <div className={classes.catalogItemNext}>
      <p>next roll in: <span className={classes.catalogNextCounter}>{game.rollTime}</span>
      </p>
    </div>
  </div>
)
